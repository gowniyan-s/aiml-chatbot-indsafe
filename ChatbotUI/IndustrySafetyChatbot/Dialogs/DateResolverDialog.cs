...
namespace IndustrySafetyChatbot.Dialogs
{
    ...
    {
        private const string PromptMsgText = "I need description of the accident";
        private const string RepromptMsgText = "I'm sorry, I need the complete description of accident for example Pressurized Systems / Chemical Substances";
